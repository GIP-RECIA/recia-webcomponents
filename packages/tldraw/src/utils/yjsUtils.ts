...
function initProvider(wsUrl: string, room: string, doc: Y.Doc): WebsocketProvider {
  return new WebsocketProvider(wsUrl, room, doc, { connect: true })
}
...
function updateDoc(doc: Y.Doc, app: TldrawApp) {
...
export { cloneDoc, getDocData, initProvider, newDoc, updateDoc }
